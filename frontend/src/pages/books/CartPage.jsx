...
import { getImgUrl } from '../../utlis/getImgUrl';
import { clearFromCart, removeFromCart } from '../../redux/features/cart/cartSlice';
...
const CartPage = () => {
    ...
    console.log(" Final products in cartItems", cartItems)
        ...
        <>
            <div className="flex mt-12 h-full flex-col overflow-hidden bg-white shadow-xl">
                <div className="flex-1 overflow-y-auto px-4 py-6 sm:px-6">
                    <div className="flex items-start justify-between">
                        ...
                        <div className="ml-3 flex h-7 items-center ">
                            <button onClick={() => handleClearFromCart()}
                                type="button"
                ...
                <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
                    ...
                    <div className="mt-6" >
                        <Link style={{ pointerEvents: totalPrice === 0 ? 'none' : 'auto', opacity: totalPrice === 0 ? 0.5 : 1 }}
                            to="/checkout"
